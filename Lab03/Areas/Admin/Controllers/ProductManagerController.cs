...
namespace Lab03.Areas.Admin.Controllers
{
    ...
    public class ProductManagerController : Controller
    {
        ...
        public ProductManagerController(IProductRepository productRepository, ICategoryRepository categoryRepository, IConfigRepository configRepository, ApplicationDbContext db)
        {
